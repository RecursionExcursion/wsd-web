  ...
  return (
    <div className={`${className}`}>
      ...
      <p className="text-lg text-muted-lavender mb-6">
        WSD Web is a powerful platform designed to streamline your development
        workflow. We believe in the power of automation and reusable scripts to
        make development faster, more reliable, and more enjoyable.
      </p>
