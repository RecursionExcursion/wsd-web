...
export default function Footer({ className = "" }: FooterProps) {
  return (
    <footer className={`footer-cosmic px-4 py-12 lg:px-8 lg:py-16 ${className}`}>
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Left: Logo */}
          <div className="flex flex-col items-start">
            <LogoTitle text="Quick Script" />
            <p className="text-muted-lavender mt-4 max-w-xs">
              Create reusable executable scripts to deploy your workspace with cosmic efficiency.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-end">
            <h3 className="text-milky-white font-semibold mb-4">Connect</h3>
            <div className="flex space-x-4">
              <a
                href="https://github.com"
                target="_blank"
                rel="noopener noreferrer"
                className="footer-social-icon hover:text-aurora-pink"
                aria-label="GitHub"
              >
        ...
        <div className="border-t border-cosmic-purple/20 mt-8 pt-8 text-center">
          <p className="text-muted-lavender text-sm">
            © 2024 Quick Script. Built with cosmic energy. ✨
          </p>
        </div>
      </div>
    </footer>
